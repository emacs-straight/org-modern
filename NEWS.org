#+title: org-modern.el - News
#+author: Daniel Mendler
#+language: en

* Version 1.15 (2026-07-22)

- ~org-modern-hide-stars~: Add custom option to replace leading stars with space.
- Do not rely on ~org-hide~ to hide colons between tags and horizontal table
  lines, since ~org-hide~ does not fully hide the character if the frame
